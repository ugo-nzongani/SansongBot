...
def is_on_promo(name, point, gain, data):
  ...
  if gain < 0 and not data[name]['bo5'][0]:
    return False
  if point + gain >= 400 and point + gain < 800:
    data[name]['bo5'][0] = True
    data[name]['elo'] = -1
    data[name]['bo5'][3] = 'not started'
    on_promo = True
  elif point + gain >= 800 and point + gain < 1200:
    data[name]['bo5'][0] = True
    data[name]['elo'] = -2
    data[name]['bo5'][3] = 'not started'
    on_promo = True
  elif point + gain >= 1200 and point + gain < 1600:
    data[name]['bo5'][0] = True
    data[name]['elo'] = -3
    data[name]['bo5'][3] = 'not started'
    on_promo = True
  elif point + gain >= 1600 and point + gain < 2000:
    data[name]['bo5'][0] = True
    data[name]['elo'] = -4
    data[name]['bo5'][3] = 'not started'
    on_promo = True
  elif point + gain >= 2000 and point + gain < 2400:
    data[name]['bo5'][0] = True
    data[name]['elo'] = -5
    data[name]['bo5'][3] = 'not started'
    on_promo = True
  elif point + gain >= 2400 and point + gain < 2800:
    data[name]['bo5'][0] = True
    data[name]['elo'] = -6
    data[name]['bo5'][3] = 'not started'
    on_promo = True
